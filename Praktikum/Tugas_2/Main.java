...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < infoBuku.length; i++) {
            ...
            bukuBaru.setSinopsisBuku("Lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod.");
            koleksiBuku.add(bukuBaru);
        }

        Buku buku1 = koleksiBuku.get(0);
        Buku buku2 = buku1.clone();

        System.out.println("Banyak kata di sinopsis: " + buku1.getPanjangSinopsis());
        System.out.println("Buku1 sama dengan buku2? : " + buku1.isEqual(buku2));
